...
\include{Number_Arithmentic}
\include{booleans_michael}
\include{boolean}
\include{boolean14}
\include{conditional_statements14}
\include{while_loops}
\include{while}
\include{Bases}
\include{array}
...
\include{Libraries_Hashlib}
\include{Libraries_Math}
\include{Libraries_Random}
\include{Libraries_Time}
\include{Graphics14}
\include{Monte_Carlo}
\include{Game_of_Life}
\include{simulations17}
